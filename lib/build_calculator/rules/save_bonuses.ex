defmodule BuildCalculator.Rules.SaveBonuses do
  ...
  ⚠ Третий источник с 12.09.2026 в сам сейв не идёт вовсе: прибавка от рангов
  **условная** (против заклинаний), и лист персонажа её не несёт — задача
  3.197, замер `AQ1`. Здесь это ничего не меняет, но соседство в этой фразе
  больше не значит «складываются в одно число».
