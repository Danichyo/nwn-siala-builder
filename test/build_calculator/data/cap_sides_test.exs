    ...
    test "названы только механизмы, и стороны такие", %{siala: s} do
      assert s.stat_cap_sources == %{
               attack_bonus: %{
                 ...
                 # Четвёртый механизм с 11.09.2026 (задача 3.184) — усиление
                 # мини-сетами, и он единственный, который не приносит своего
                 # бонуса, а увеличивает два предыдущих. Сторона у него та же,
                 # и объявлена она ДАННЫМИ, а не выведена из стороны
                 # усиливаемого: «сторона усилителя равна стороне усиливаемого»
                 # звучит как правило и им не является.
                 mini_sets: %{inside?: true, assumed?: false}
               },
               saving_throw_bonus: %{
